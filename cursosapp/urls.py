...
urlpatterns = [
    ...
    path('estudiantes/', ListarEstudiantes.as_view(), name='lista_estudiantes'),
    path('estudiantes/crear/', CrearEstudiante.as_view(), name='crear_estudiante'),
    path('estudiantes/<int:estudiante_id>/editar/', ActualizarEstudiante.as_view(), name='actualizar_estudiante'),
    path('estudiantes/<int:estudiante_id>/borrar/', BorrarEstudiante.as_view(), name='borrar_estudiante'),
    
    path('inscripciones/', ListarInscripciones.as_view(), name='lista_inscripciones'),
